...
router.patch('/', async (req, res) => {
    ...
    try {
            ...
            try {
                ...
                if (tranxAmount == 0) {
                    ...
                    if (mpesaNumber === 254) {
                        ...
                        res.json({ data: 'Deposit Complete', statusCode: 1000 })
               ...
               res.json({ data: 'Update Error!!..Refresh Account in Home page', statusCode: 1002 })
        ...
        res.json({ data: 'Server Error!!..All pending Deposits will be settled shortly', statusCode: 505 })
